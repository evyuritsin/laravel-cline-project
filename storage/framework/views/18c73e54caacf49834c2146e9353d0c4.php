...
<head>
    ...
    <!-- Meta Description -->
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'A modern Laravel application'); ?>">
...
<body>
    ...
    <header>
        <div class="container">
            <nav class="navbar">
                <a href="<?php echo e(url('/')); ?>" class="text-xl font-bold">
    ...
    <main>
        ...
        <section class="hero">
            <div class="container">
                <h1>Welcome to <?php echo e(config('app.name', 'Laravel')); ?></h1>
                <p class="mt-2">A modern Laravel application with HTML5 boilerplate</p>
                <div class="mt-4">
                    <a href="<?php echo e(url('/about')); ?>" class="btn">Learn More</a>
                    <a href="<?php echo e(url('/contact')); ?>" class="btn btn-secondary ml-2">Get Started</a>
                </div>
            </div>
        </section>
...
</html><?php /**PATH /var/www/html/resources/views/boilerplate.blade.php ENDPATH**/ ?>